...
export const  RegistrationForm = (props: RegistrationFormProps) => {
    ...
    return (
        ...
        <form className={`relative ${props.mainColor} shadow-md rounded px-8 pt-6 pb-8 mb-4`} onSubmit={handleSubmit}>
          {props.popup ?
          ...
          <div className="flex items-center justify-center">
            <button className={`${props.secondaryColor} hover:bg-gray-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline`} type="submit">
              Register
            </button>
          </div>
        </form>
